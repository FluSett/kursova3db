...
import 'package:kursova/pages/librarian/librarian_sign_up.dart';
import 'package:kursova/widgets/loading.dart';

class LibrarianSignInPage extends StatefulWidget {
  @override
  _LibrarianSignInPageState createState() => _LibrarianSignInPageState();
}

class _LibrarianSignInPageState extends State<LibrarianSignInPage> {
              ...
              child: InkWell(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => LibrarianSignUpPage()),
                  );
                },
                child: SizedBox(
                  height: height * 0.03,
